                            ...
                            <div class="form-bottom">
			                    <form role="form" action="register" method="post" class="registration-form">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="text" name="email" placeholder="请输入Email" class="form-email form-control" id="form-email">
			                        </div>
			                         <div class="form-group">
			                        	<label class="sr-only" for="form-email">telephone</label>
			                        	<input type="text" name="telephone" placeholder="请输入电话" class="form-email form-control" id="form-email">
			                        </div>
